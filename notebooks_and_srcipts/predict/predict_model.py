...
# Model paths
OBJECT_DETECTOR_PATH = '../../setup/setup_server/mqtt_and_analyze/models/object_detector.tflite'
CLASSIFICATION_MODEL_PATH = '../../setup/setup_server/mqtt_and_analyze/models/classifier.h5'
